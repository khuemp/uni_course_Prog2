...
public class ConstExpression implements Expression {
    ...
    /**
     * Überprüft auf Gleichheit mit einem anderen Objekt. Dieses Objekt ist gleich
     * einem anderen genau dann, wenn: - Das andere Object auch eine Expression ist
     * - Die andere Expression zum gleichen Wert auswertet wie diese
     */
    @Override
