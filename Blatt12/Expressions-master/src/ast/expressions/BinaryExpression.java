...
public abstract class BinaryExpression implements Expression {
    ...
    /**
     * Diese Methode soll zwei beliebige Ausdrücke bezüglich ihres evaluierten
     * Wertes vergleichen. Beachte, dass diese Methode von allen Unterklassen
     * genutzt werden kann.
     */
    @Override
    ...
    public String toString() {
        // DONE: implement me
        return "(" + this.lhs.toString() + " " + this.operator.toString() + " " + this.rhs.toString() + ")";
    }
